      ...
      >
        <div className="glass shadow-2xl shadow-black/50 rounded-3xl p-8 md:p-10 border border-white/[0.08] bg-white/[0.02] backdrop-blur-xl">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between ml-1">
                ...
                <Link href="#" className="text-xs text-gold/80 hover:text-gold transition-colors">Forgot password?</Link>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-500">
          ...
          <div className="mt-8 text-center text-sm text-gray-400 font-light">
            ...
            <Link href="/signup" className="text-white hover:text-gold transition-colors font-medium">
              Create one
            </Link>
          </div>
        </div>
